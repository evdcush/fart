"""
This file was copied AS-IS from the excellent ``Pyperclip`` package.
Copyright BSD by Al Sweigart, al@inventwithpython.com

It was copied, rather than 'required', so that we can all fart without
any extra deps.

Big thanks to Mr. Al Sweigart and all the contribs of Pyperclip!
...
REFERENCE
=========
Details on the Pyperclip source.

:url: https://github.com/asweigart/pyperclip/blob/\
781603ea491eefce3b58f4f203bf748dbf9ff003/src/pyperclip/__init__.py

:file: github.com/asweigart/pyperclip/blob/master/src/pyperclip/__init__.py
:commit: 781603e
:version: ``1.8.2``
:accessed: 2023/03/04
"""
